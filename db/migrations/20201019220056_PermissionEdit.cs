    ...
    public partial class PermissionEdit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { new DateTimeOffset(new DateTime(2020, 10, 19, 22, 0, 55, 330, DateTimeKind.Unspecified).AddTicks(2062), new TimeSpan(0, 0, 0, 0, 0)), "View Assigned Location", "ViewAssignedLocation" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 27, null, new DateTimeOffset(new DateTime(2020, 10, 19, 22, 0, 55, 330, DateTimeKind.Unspecified).AddTicks(2068), new TimeSpan(0, 0, 0, 0, 0)), "View Home Location", "ViewHomeLocation", null, null });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 23,
                columns: new[] { "CreatedOn", "Description", "Name" },
                values: new object[] { new DateTimeOffset(new DateTime(2020, 10, 17, 1, 43, 25, 61, DateTimeKind.Unspecified).AddTicks(5934), new TimeSpan(0, 0, 0, 0, 0)), "View Home Location and Assigned Location", "ViewHomeLocationAndAssignedLocation" });
