    ...
    public partial class DutyPermissions : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 36, null, new DateTimeOffset(new DateTime(2020, 11, 5, 0, 13, 30, 922, DateTimeKind.Unspecified).AddTicks(3539), new TimeSpan(0, 0, 0, 0, 0)), "Expire Duties", "ExpireDuties", null, null },
                    { 35, null, new DateTimeOffset(new DateTime(2020, 11, 5, 0, 13, 30, 922, DateTimeKind.Unspecified).AddTicks(3537), new TimeSpan(0, 0, 0, 0, 0)), "Edit Duties", "EditDuties", null, null },
                    { 34, null, new DateTimeOffset(new DateTime(2020, 11, 5, 0, 13, 30, 922, DateTimeKind.Unspecified).AddTicks(3535), new TimeSpan(0, 0, 0, 0, 0)), "Create Duties", "CreateAndAssignDuties", null, null },
                    { 33, null, new DateTimeOffset(new DateTime(2020, 11, 5, 0, 13, 30, 922, DateTimeKind.Unspecified).AddTicks(3533), new TimeSpan(0, 0, 0, 0, 0)), "View Duties", "ViewDuties", null, null }
                });
